...
<style type="text/css">
	...
	table {width: 1200px; margin-left: auto; margin-right: auto;
				 font-size: 16pt!important; border-collapse: collapse;}
...
<tr>
	<td align="center"><img alt="" src="${pageContext.request.contextPath}/resources/images/${cdto.img}" width="150">
		<input type="hidden" name="p_img_name" value="${cdto.img}">
		<input type="hidden" name="c_code" value="${cdto.c_code}"></td>
	<td align="center">
		${cdto.brand} <input type="hidden" name="p_brand" value="${cdto.brand}"><br>
		${cdto.title} <input type="hidden" name="p_title" value="${cdto.title}"><br>
		${cdto.color} / ${cdto.psize} <input type="hidden" name="p_color" value="${cdto.color}"> <input type="hidden" name="p_psize" value="${cdto.psize}"><br>	
	</td>
...
<tr>
	<td class="bot1" colspan="3" align="right">
		...
		주문금액 <fmt:formatNumber value="${cdto.price + cdto.delivery}" type="number"/>원
		<input type="hidden" name="p_price" value="${cdto.price}">
		<input type="hidden" name="p_delivery" value="${cdto.delivery}">
	</td>	
</tr>
</c:forEach>
<tr>
	<td class="bot2" colspan="3" align="right">
		...
		<input type="hidden" name="p_totalprice" value="${total}">
	</td>
</tr>
...
<tr>
	...
	<td class="bot2" align="right"><fmt:formatNumber value="${totalPrice}" type="number"/>원</td>
</tr>
<tr>
	<td align="left" class="bot2">배송비</td>
	<td align="right" class="bot2"><fmt:formatNumber value="${totalDelivery}" type="number"/>원 </td>
</tr>
<tr>
	<td class="bot1" align="left"><font style="font-weight: bold; font-size: 18pt;">총 결제예상 금액</font></td>
	<td class="bot1" align="right" width="200"><font style="font-weight: bold; color: #DBA901; font-size: 22pt;"><fmt:formatNumber value="${total}" type="number"/>원</font></td>
</tr>
</table>
</div>
