...
<br><br>
<form method="post" name="myform" enctype="multipart/form-data" accept-charset="utf-8" action="productEdit.do">
<div align="center">
<table>
<tr>
...
<tr>
	...
	<td align="left" colspan="2"><input type="text" name="brand" value="${pdto.brand}" placeholder="브랜드입력란"> </td>
</tr>
<tr>
	<td align="left" >제목</td>
	<td align="left" ><input type="text" name="title" value="${pdto.title}" placeholder="제목입력란"> </td>
</tr>
<tr>
	<td align="left">가격</td>
	<td align="left"><input type="text" name="price" value="${pdto.price}" placeholder="가격입력란 예)12000"> </td>
</tr>
<tr>
	<td align="left">배송비</td>
	<td align="left"><input type="text" name="delivery" value="${pdto.delivery}" placeholder="배송비입력란 예)2500"> </td>
</tr>
<tr>
	<td align="left">색상</td>
	<td align="left"><input type="text" name="color" value="${pdto.color}" placeholder="색상입력란 예)blak,white,brown"> </td>
</tr>
<tr>
	<td align="left">사이즈</td>
	<td align="left"><input type="text" name="psize" value="${pdto.psize}" placeholder="사이즈입력란 예)S,M,L"> </td>
</tr>
<tr>
	<td align="left">분류</td>
	<td align="left">
		<input type="radio" name="category" value="1" <c:if test="${pdto.category==1}"> checked="checked" </c:if> >상의 
		<input type="radio" name="category" value="2" <c:if test="${pdto.category==2}"> checked="checked" </c:if> >하의
		<input type="radio" name="category" value="3" <c:if test="${pdto.category==3}"> checked="checked" </c:if> >아웃터
	</td>
</tr>
<tr>
