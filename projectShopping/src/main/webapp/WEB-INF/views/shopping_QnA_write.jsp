...
<br><br>
<form name="myform" action="qnaInsert.do">
<div align="center">
<table>
<tr>
	<td class="bot1" colspan="3" align="left">
		<font style="font-size: 22pt;">고객문의 글쓰기</font>
	</td>
</tr>
<tr>
	<td width="200"  align="left">아이디</td>
	<td align="left">
		<input type="hidden" name="userid" value="${idch}">
		<input type="hidden" name="userpwd" value="1234"> ${idch} </td>
</tr>
<tr>
	<td align="left">제목</td>
...
<tr>
	...
	<td class="bot1" align="left"><textarea rows="20" cols="60" name="content"></textarea> </td>
</tr>
</table>
</div>
...
<a class="but1" href="qnaList.do">취소</a>
</div>
</div>
</form>
