...
<br><br>
<body>
<form name="myform" action="noticeEedit.do">
<div align="center">
<table>
<tr>
	<td class="bot1" colspan="3" align="left">
		<input type="hidden" name="code" value="${ndto.code}">
		<font style="font-size: 22pt;">공지사항 수정</font>
	</td>
</tr>
<tr>
	<td width="200"  align="left">제목</td>
	<td align="left"> <input type="text" name="title" placeholder="제목입력란" value="${ndto.title}"> </td>
</tr>
<tr>
	<td class="bot1" align="left">내용</td>
	<td class="bot1" align="left"><textarea rows="20" cols="60" name="content">${ndto.content}</textarea> </td>
</tr>
</table>
</div>
