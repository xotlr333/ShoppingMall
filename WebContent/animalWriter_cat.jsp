...
<form name="w_form" method="post" enctype="multipart/form-data" action="animalWriterSave_cat.jsp" >
 <div class="container">
     <table width=860px>
     ...
     <h4>게시판 글쓰기</h4><p>
       <div>
        <input type="text" placeholder="제목을 입력해주세요." name="c_title" value="" >
       </div><br>
         
	     <div>
	       <textarea style="resize: none; " name="c_content" cols="95" rows="10" class="textarea"  placeholder="내용을 입력해주세요."  ></textarea>
	     </div>
     ...
     <h4>반려동물 정보</h4>
        <div>   
          <table width="860px">
            ...
            <td>
             <label>이름&nbsp;</label>
                <input type="text" placeholder="반려동물 이름" name="c_animal_name"> 
            </td>
              
            <td style="text-align:left;">
              <label>성별&nbsp;&nbsp;</label>
               <input type="radio" id="gender_m" name="c_gender" value="male" style="padding-right:20px;" checked="checked">
               <label for="gender_m">수컷</label>&nbsp;
               <input type="radio" id="gender_w" name="c_gender" value="female">
          ...
          <br>
          <div>
            <button type="reset" style="height:35px; width:430px; background-color: white; color : #fdd017; ">취소하기</button>
            <button type="button" onclick="checkNull()" style="height:35px; width:430px; background-color:  #fdd017; color: white;">등록하기</button>
          </div>        
