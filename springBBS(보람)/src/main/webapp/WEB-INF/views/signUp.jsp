	  ...
	  <div class="row">
	    ...
	    <form name="acct"  method="post" action="acct_insert.do">
		   ...
		   <div class="control-group">
	         <div class="form-group floating-label-form-group controls">
	           <label>패스워드</label>
	           <input type="text" class="form-control" placeholder="패스워드" name="s_pw" id="s_pw1" value="1234" required>
	       ...
	       <div class="control-group">
	         <div class="form-group floating-label-form-group controls">
	           <label>패스워드 확인</label>
	           <input type="text" class="form-control" placeholder="패스워드 확인" name="s_pw2" id="s_pw2" onkeyup="pwCheck();" required>
	       ...
	       <div class="control-group">
	         <div class="form-group floating-label-form-group controls">
	           <label>이름</label>
	           <input type="text" class="form-control" placeholder="이름" name="s_name" id="s_name" required>
	       ...
	       <div class="control-group">
	         <div class="form-group floating-label-form-group controls">
	           <label >성별</label>
	           <input type="radio" class="form-control" name="s_gender" value="male">남자
	       ...
	       <div class="control-group">
	         <div class="form-group floating-label-form-group controls">
	           <label>연락처</label>
	           <input type="tel" placeholder="연락처(010-1234-9876)" id="s_phone" name="s_phone" onblur="phoneCheck();" required>
	       ...
	       <div class="control-group">
	         <div class="form-group floating-label-form-group controls">
	           <label>이메일</label>
	           <input type="email" class="form-control" placeholder="goo@tis.com" name="s_email" id="s_email" onkeyup="emailCheck();" required>
